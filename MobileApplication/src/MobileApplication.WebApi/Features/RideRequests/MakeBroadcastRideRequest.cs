namespace MobileApplication.WebApi.Features.RideRequests
{
    ...
    public class MakeBroadcastRideRequest
    {
        public class MakeBroadcastRideRequestCommand : IRequest<RideRequestDto>
        {
            public RideRequestForCreationDto RideRequestToAdd { get; set; }

            public MakeBroadcastRideRequestCommand(RideRequestForCreationDto rideRequestToAdd)
            {
        ...
        public class Handler : IRequestHandler<MakeBroadcastRideRequestCommand, RideRequestDto>
        {
            ...
            public async Task<RideRequestDto> Handle(MakeBroadcastRideRequestCommand request, CancellationToken cancellationToken)
            {
