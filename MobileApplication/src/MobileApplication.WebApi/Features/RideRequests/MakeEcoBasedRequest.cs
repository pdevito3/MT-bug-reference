namespace MobileApplication.WebApi.Features.RideRequests
{
    ...
    public class MakeEcoBasedRequest
    {
        public class MakeEcoBasedRequestCommand : IRequest<RideRequestDto>
        {
            public RideRequestForCreationDto RideRequestToAdd { get; set; }

            public MakeEcoBasedRequestCommand(RideRequestForCreationDto rideRequestToAdd)
            {
        ...
        public class Handler : IRequestHandler<MakeEcoBasedRequestCommand, RideRequestDto>
        {
            ...
            public async Task<RideRequestDto> Handle(MakeEcoBasedRequestCommand request, CancellationToken cancellationToken)
            {
