...
namespace MobileApplication.FunctionalTests
{
    ...
    public class TestingWebApplicationFactory : WebApplicationFactory<Startup>
    {
        protected override void ConfigureWebHost(IWebHostBuilder builder)
        {
            ...
            builder.ConfigureServices(services =>
            {
                ...
                // Add a database context (MobileApplicationDbContext) using an in-memory database for testing.
                ...
                // Create a scope to obtain a reference to the database context (MobileApplicationDbContext).
                using (var scope = sp.CreateScope())
                {
                    var scopedServices = scope.ServiceProvider;
                    var db = scopedServices.GetRequiredService<MobileApplicationDbContext>();
